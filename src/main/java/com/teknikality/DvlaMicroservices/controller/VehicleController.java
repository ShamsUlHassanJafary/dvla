package com.teknikality.DvlaMicroservices.controller;
...
import com.teknikality.DvlaMicroservices.services.VehicleService;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 * "Provide registration number to lookup specific vehicle from local database otherwise from DVLA. it is also store the vehicle information in localdatabase"
	 * , response = Vehicle.class) public ResponseEntity<Vehicle>
	 * getVehicleDataFromAPI(@ApiParam(value =
	 ...
	 * IOException, InterruptedException { logger.info("Vehicle object is created");
	 * Vehicle vehicle = new Vehicle();
	 * 
	 * try { logger.info("going to call from database"); vehicle =
	 * vehicleService.getVehicle(registrationNumber);
	 * logger.info(" call  done from database"); String str =
	 ...
	 * !vehicle.getRegistrationNumber().isEmpty()) {
	 ...
	 * 
	 * // Deleting the out dated Vehicle information and Storing new one
	 * 
	 * vehicleService.deleteVehicle(registrationNumber); vehicle =
	 * vehicleService.consumeApi(registrationNumber);
	 * 
	 * }
	 * 
	 * }else { logger.info("in else block"); vehicle =
	 * vehicleService.consumeApi(registrationNumber);
	 * 
	 * return new ResponseEntity<>(vehicle, HttpStatus.OK); }
	 * 
	 * 
	 * } catch (Exception e) { logger.info("in catch block "); vehicle =
	 * vehicleService.consumeApi(registrationNumber);
	 * logger.info("After calling consume api in Catch block ");
...
////////////////////////////////////////////////Direct using api and save the date/////////////////////////////////////	
	/*
	 * @GetMapping("/api/{registrationNumber}")
	 * 
	 * @ApiOperation(value = "find vehicle by registration number", notes =
	 * "Provide registration number to lookup specific vehicle from DVLA it is also store the vehicle information in localdatabase"
	 * , response = Vehicle.class) public ResponseEntity<Vehicle>
...
///////////////////////////////////////////////////Update Vehicle Record ///////////////////////////////////////////////	
	...
	@ApiOperation(value = "find vehicle by registration number", notes = "Provide registration number to lookup specific vehicle from localdatabse if it is not in it or older then a month then retrive from DVLA Api and  also store the vehicle information in localdatabase", response = Vehicle.class)
...
//		    vehicle = new Vehicle();
	 ...
	 * getVehicleReport(@PathVariable("format") String format) throws IOException,
	 * InterruptedException, JRException{ String location =
	 * vehicleService.expoertReport(format); return new
